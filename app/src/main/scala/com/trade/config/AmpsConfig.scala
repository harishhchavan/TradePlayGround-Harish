...
case class AmpsConfig(host: String, port: Int, topicTradesRaw: String, topicTradesEnriched: String, topicTradesValidated: String, topicTradesFigured: String)

object AmpsConfig extends AbstractConfig{

  val ampsConfig = AmpsConfig(
